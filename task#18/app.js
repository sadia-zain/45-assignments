"use strict";
let favoritePlaces = ["Pakistan", "Turkey", "Palestine", "SaudiArabia"];
...
favoritePlaces.sort();
console.log("Alphabatic order:", favoritePlaces);
favoritePlaces.reverse();
console.log("Reversed alphabatic order:", favoritePlaces);
